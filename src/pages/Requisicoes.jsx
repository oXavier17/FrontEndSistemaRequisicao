...
export default function Materiais() {
  ...
  const { fornecedores, criar: criarFornecedor, editar: editarFornecedor, excluir: excluirFornecedor } = useFornecedores();
  ...
  const handleMovimentacao = async () => {
    ...
    try {
      ...
      // Mock local — substituir por:
      // await api.post(`/materiais/${mov.materialId}/movimentacao`, {
      //   tipo: mov.tipo, quantidade: qtd,
      //   fornecedorId: mov.fornecedorId || null,
      //   preco: mov.preco || null,
      ...
      setSucessoMov(`${mov.tipo === 'entrada' ? 'Entrada' : 'Saída'} de ${qtd} ${UNIDADE_LABEL[material?.unidade] ?? ''} de "${material?.nome}" registrada com sucesso.`);
      setMov(emptyMov);
